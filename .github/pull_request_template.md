...
- [ ] Relevant tests pass with synthetic data
- [ ] `pnpm check` passes
- [ ] Manual verification and affected platforms are documented
- [ ] Recovery/rollback behavior is verified where applicable
...
- [ ] Documentation and threat model are updated where affected
- [ ] Schema/migration and compatibility matrix are updated where affected
